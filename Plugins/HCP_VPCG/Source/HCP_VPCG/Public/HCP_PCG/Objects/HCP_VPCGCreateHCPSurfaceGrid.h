...
#include "HCP_VPCGCreateHCPSurfaceGrid.generated.h"
...
UENUM()
enum class UE_DEPRECATED(5.4, "Not used anymore, replaced by EHCP_VPCGCoordinateSpace.") EHCP_VPCGSurfaceGridPivot : uint8
{
	Global,
		OriginalComponent,
		LocalComponent
...
class UHCP_VPCGCreateHCPSurfaceGridSettings : public UPCGSettings
{
	GENERATED_BODY()

public:
	UHCP_VPCGCreateHCPSurfaceGridSettings();
...
#if WITH_EDITOR
	virtual FName GetDefaultNodeName() const override { return FName(TEXT("CreateHcpSurfacesGrid")); }
	virtual FText GetDefaultNodeTitle() const override { return NSLOCTEXT("HCP_VPCGCreateSurfaceGridElement", "NodeTitle", "Create HCP Surface Points Grid"); }
	virtual FText GetNodeTooltipText() const override { return NSLOCTEXT("HCP_VPCGCreateSurfaceGridElement", "NodeTooltip", "Creates a 2D hexagonal surface grid of points."); }
...
public:
	...
	FVector2D GridExtents = FVector2D(500.0, 500.0);
	...
	PRAGMA_DISABLE_DEPRECATION_WARNINGS
		...
		UPROPERTY()
	EHCP_VPCGSurfaceGridPivot GridPivot_DEPRECATED = EHCP_VPCGSurfaceGridPivot::Global;
...
class FHCP_VPCGCreateSurfaceGridElement : public IPCGElement
{
public:
